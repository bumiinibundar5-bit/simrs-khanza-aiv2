 ...
 * @author perpustakaan
 */
public class DlgMarkingImageAssMedisGigi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgMarkingImageAssMedisGigi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        PilihWarna.setBounds(650, 10, 150, 20);
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/lokalisgigi.png"))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        String fileName = "assMdsGigi" + noRawat + ".png";
        ...
        try {
            ...
            Logger.getLogger(DlgMarkingImageAssMedisGigi.class.getName()).log(Level.SEVERE, null, ex);
            return;
        }

        // Unggah gambar
        if (!uploadImage(fileName, "assesmentmedisgigi/imagemarking")) {
            JOptionPane.showMessageDialog(this, "Gagal mengunggah gambar!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Simpan ke database
        String urlImage = "assesmentmedisgigi/imagemarking/" + fileName;
        boolean success = Sequel.cariInteger("SELECT COUNT(no_rawat) FROM asesmen_medis_gigi_image_marking WHERE no_rawat = ?", TNoRawat.getText()) > 0
                ? Sequel.mengedittf("asesmen_medis_gigi_image_marking", "no_rawat=?", "tanggal=?,jam=?,url_image=?", 4, new String[]{
            tanggalNow.format(new Date()), jamNow.format(new Date()), urlImage, TNoRawat.getText()})
                : Sequel.menyimpantf("asesmen_medis_gigi_image_marking", "?,?,?,?", "No.Rawat", 4, new String[]{
...
//        System.out.println(index);
    ...
    private void BtnHapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus1ActionPerformed
        imageAssesment("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/imagefreehand/masterimage/lokalisgigi.png");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageAssMedisGigi dialog = new DlgMarkingImageAssMedisGigi(new javax.swing.JFrame(), true);
...
//        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
    ...
    public void setNoRw(String norw) {
        ...
        urlImage = Sequel.cariIsi("select url_image from asesmen_medis_gigi_image_marking where no_rawat='" + norw + "' ");
    ...
    boolean uploadImage(String fileName, String docPath) {
        try {
            ...
            Logger.getLogger(DlgMarkingImageAssMedisGigi.class.getName()).log(Level.SEVERE, "Upload error", e);

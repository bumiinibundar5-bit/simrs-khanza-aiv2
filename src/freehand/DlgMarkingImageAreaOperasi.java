...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Marking Area Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        try {
            ...
            String fileName = "PenandaanOperasi" + TNoRawat.getText().replaceAll("/", "") + ".png";
            ...
            String imagePath = "PenandaanOperasi/imagemarking/" + fileName;
            uploadImage(fileName, "PenandaanOperasi/imagemarking");

            // Periksa apakah data sudah ada
            String queryCheck = "SELECT COUNT(no_rawat) AS jumlah FROM penandaan_area_operasi_image_marking WHERE no_rawat='" + TNoRawat.getText() + "'";
            ...
            if (dataExists) {
                ...
                Sequel.mengedittf("penandaan_area_operasi_image_marking", "no_rawat=?", "tanggal=?,jam=?,url_image=?", updateParams.length, updateParams);
            } else {
                ...
                Sequel.menyimpantf("penandaan_area_operasi_image_marking", "?,?,?,?", "No.Rawat", insertParams.length, insertParams);
            }

...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilMDT = new javax.swing.JMenuItem();
        ...
        MnCetakHasilMDT.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilMDT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilMDT.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilMDT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilMDT.setText("Cetak MDT");
        MnCetakHasilMDT.setName("MnCetakHasilMDT"); // NOI18N
        MnCetakHasilMDT.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilMDT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilMDTActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilMDT);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilMDTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilMDTActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabMDTPermintaan.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);  
                            }else{
                                Valid.MyReport("rptPeriksaLab2.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);  
                            }
                        } catch (Exception e) {
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilMDTActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilMDT;

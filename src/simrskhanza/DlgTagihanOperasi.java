...
public class DlgTagihanOperasi extends javax.swing.JDialog {
    ...
    public DlgTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        komplikasi.setDocument(new batasInput((int)100).getKata(komplikasi));
        pendarahan.setDocument(new batasInput((int)100).getKata(pendarahan));
        nomoralat.setDocument(new batasInput((int)100).getKata(nomoralat));
        ...
        template.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(template.getTable().getSelectedRow()!= -1){  
                    ...
                    pendarahan.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),8).toString());
                    nomoralat.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),9).toString());
    ...
    private void initComponents() {
        ...
        Joperasi = new widget.ComboBox();
        Moperasi = new widget.ComboBox();
        ...
        label11.setBounds(690, 10, 101, 23);
        ...
        TPasien.setBounds(265, 10, 470, 23);

        jLabel4.setText("Jenis Anasthesi :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(610, 40, 90, 23);
        ...
        jLabel5.setText("Macam Operasi :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(380, 40, 81, 23);

        Kategori.setMaximumRowCount(15);
        ...
        Kategori.setBounds(90, 40, 100, 23);
        ...
        label12.setBounds(890, 10, 101, 23);
        ...
        Jaringan.setBounds(150, 500, 350, 23);

        jLabel9.setText("Pemeriksaan PA :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(410, 400, 100, 23);
        ...
        DikirimPA.setBounds(520, 400, 90, 23);
        ...
        scrollPane2.setBounds(830, 70, 320, 350);

        jLabel10.setText("Laporan Operasi :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(820, 40, 101, 23);
        ...
        btnTemplate.setBounds(930, 40, 28, 23);

        Joperasi.setMaximumRowCount(15);
        Joperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Elektive", "Emergency", "Urgent" }));
        Joperasi.setName("Joperasi"); // NOI18N
        Joperasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                JoperasiKeyPressed(evt);
            }
        });
        FormInput.add(Joperasi);
        Joperasi.setBounds(200, 40, 170, 23);

        Moperasi.setMaximumRowCount(15);
        Moperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bersih", "Bersih Terkontaminasi", "Terkontaminasi", "Kotor", "Terinfeksi" }));
        Moperasi.setName("Moperasi"); // NOI18N
        Moperasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MoperasiKeyPressed(evt);
            }
        });
        FormInput.add(Moperasi);
        Moperasi.setBounds(470, 40, 140, 23);

        jLabel11.setText("Kategori :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(0, 40, 81, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Pendarahan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(510, 470, 145, 23);

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel14.setText("Nomor alat yang di pasang :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(510, 500, 145, 23);
        ...
        pendarahan.setBounds(660, 470, 490, 23);
        ...
        komplikasi.setBounds(660, 440, 490, 23);
        ...
        FormInput.add(nomoralat);
        nomoralat.setBounds(660, 500, 490, 23);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("Komplikasi :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(510, 440, 145, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
   isForm();  
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                for(i=0;i<tbtindakan.getRowCount();i++){
                    if(tabMode.getValueAt(i,0).toString().equals("true")){
                        if(Sequel.menyimpantf2("operasi","'"+TNoRw.getText()+"','"+Valid.SetTgl(tgl.getSelectedItem()+"")+" "+tgl.getSelectedItem().toString().substring(11,19)
                            +"','"+jenis.getText()+"','"+Kategori.getSelectedItem()+"','"+Joperasi.getSelectedItem()+"','"+Moperasi.getSelectedItem()+"','"+kdoperator1.getText()+"','"+kdoperator2.getText()+"','"+kdoperator3.getText()
                ...
                if(sukses==true){
                    if(!Laporan.getText().equals("")){
                        if(Sequel.menyimpantf2("laporan_operasi","?,?,?,?,?,?,?,?,?,?,?","laporan operasi",11,new String[]{
                                TNoRw.getText(),Valid.SetTgl(tgl.getSelectedItem()+"")+" "+tgl.getSelectedItem().toString().substring(11,19),PreOp.getText(),
                                PostOp.getText(),Jaringan.getText(),komplikasi.getText(),pendarahan.getText(),
                                nomoralat.getText(),Valid.SetTgl(tgl2.getSelectedItem()+"")+" "+tgl2.getSelectedItem().toString().substring(11,19),
    ...
    private void JoperasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JoperasiKeyPressed
        Valid.pindah(evt,TCariPaket,jenis);
    }//GEN-LAST:event_JoperasiKeyPressed

    private void MoperasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MoperasiKeyPressed
        Valid.pindah(evt,TCariPaket,jenis);
    }//GEN-LAST:event_MoperasiKeyPressed

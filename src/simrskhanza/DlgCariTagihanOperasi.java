...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnBHP = new javax.swing.JMenuItem();
        ...
        nomoralat = new widget.TextBox();
        WindowBHP = new javax.swing.JDialog();
        internalFrame7 = new widget.InternalFrame();
        panelGlass8 = new widget.panelisi();
        btnAmbilPhoto2 = new widget.Button();
        ...
        MnBHP.setBackground(new java.awt.Color(255, 255, 254));
        MnBHP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnBHP.setForeground(new java.awt.Color(50, 50, 50));
        MnBHP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnBHP.setText("Ubah OBAT dan BHP");
        MnBHP.setName("MnBHP"); // NOI18N
        MnBHP.setPreferredSize(new java.awt.Dimension(220, 26));
        MnBHP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnBHPActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnBHP);
        ...
        komplikasi.setBounds(30, 260, 256, 23);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel11.setText("Pendarahan :");
        jLabel11.setName("jLabel11"); // NOI18N
        panelGlass7.add(jLabel11);
        jLabel11.setBounds(10, 290, 200, 23);
        ...
        pendarahan.setBounds(30, 320, 256, 23);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("Nomor Alat :");
        jLabel12.setName("jLabel12"); // NOI18N
        panelGlass7.add(jLabel12);
        jLabel12.setBounds(10, 350, 200, 23);

        nomoralat.setHighlighter(null);
        nomoralat.setName("nomoralat"); // NOI18N
        nomoralat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nomoralatActionPerformed(evt);
            }
        });
        nomoralat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nomoralatKeyPressed(evt);
            }
        });
        panelGlass7.add(nomoralat);
        nomoralat.setBounds(30, 380, 256, 23);
        ...
        WindowBHP.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowBHP.setName("WindowBHP"); // NOI18N
        WindowBHP.setUndecorated(true);
        WindowBHP.setResizable(false);
        WindowBHP.getContentPane().setLayout(new java.awt.BorderLayout(1, 1));
        ...
        btnAmbilPhoto2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnAmbilPhoto2.setMnemonic('U');
        btnAmbilPhoto2.setText("Ambil Data");
        btnAmbilPhoto2.setToolTipText("Alt+U");
        btnAmbilPhoto2.setName("btnAmbilPhoto2"); // NOI18N
        btnAmbilPhoto2.setPreferredSize(new java.awt.Dimension(105, 30));
        btnAmbilPhoto2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAmbilPhoto2ActionPerformed(evt);
            }
        });
        panelGlass8.add(btnAmbilPhoto2);
        ...
        panelGlass8.add(BtnCloseIn6);

        internalFrame7.add(panelGlass8, java.awt.BorderLayout.PAGE_END);

        panelGlass9.setName("panelGlass9"); // NOI18N
        panelGlass9.setPreferredSize(new java.awt.Dimension(300, 55));
        ...
        Scroll.setBounds(40, 10, 452, 402);

        internalFrame7.add(panelGlass9, java.awt.BorderLayout.WEST);

        WindowBHP.getContentPane().add(internalFrame7, java.awt.BorderLayout.CENTER);
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    private void MnUbahLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbahLaporanActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                    rs2=koneksi.prepareStatement(
                        "select laporan_operasi.diagnosa_preop,laporan_operasi.diagnosa_postop,laporan_operasi.jaringan_dieksekusi,laporan_operasi.komplikasi,laporan_operasi.pendarahan,laporan_operasi.nomoralat,laporan_operasi.selesaioperasi,laporan_operasi.permintaan_pa,"+
                    ...
                    if(rs2.next()){
                        ...
                        pendarahan.setText(rs2.getString("pendarahan"));
                        nomoralat.setText(rs2.getString("nomoralat"));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(!Laporan.getText().equals("")){
            Sequel.queryu("delete from laporan_operasi where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1)+"' and tanggal='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +"'");
            Sequel.menyimpan("laporan_operasi","?,?,?,?,?,?,?,?,?,?,?","laporan operasi",11,new String[]{
                ...
                PostOp.getText(),Jaringan.getText(),komplikasi.getText(),pendarahan.getText(),nomoralat.getText(),Valid.SetTgl(tgl2.getSelectedItem()+"")+" "+tgl2.getSelectedItem().toString().substring(11,19),
    ...
    private void nomoralatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nomoralatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nomoralatKeyPressed
    ...
    private void nomoralatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nomoralatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nomoralatActionPerformed

    private void btnAmbilPhoto2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhoto2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAmbilPhoto2ActionPerformed
    ...
    private void MnBHPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBHPActionPerformed
        // TODO add your handling code here:
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                ...
                WindowBHP.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                WindowBHP.setLocationRelativeTo(internalFrame1);
                WindowBHP.setVisible(true);
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data, klik pada No.Rawat ..!!");
            } 
        }
    
    }//GEN-LAST:event_MnBHPActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnBHP;
    ...
    private javax.swing.JDialog WindowBHP;
    ...
    private widget.Button btnAmbilPhoto2;
    ...
    private widget.TextBox nomoralat;

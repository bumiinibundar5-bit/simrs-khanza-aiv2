...
public final class RMHasilPemeriksaanEcho extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanEcho(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","Kode Dokter","Nama Dokter","Tanggal","Diagnosa Klinis","Kiriman Dari","Kesimpulan"
        }){
    ...
    private void initComponents() {
        ...
        MnPenilaianMedis.setText("Formulir Hasil Pemeriksaan ECHO");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan ECHO ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-02-2024 19:42:38" }));
        ...
        KirimanDari.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KirimanDariActionPerformed(evt);
            }
        });
        ...
        DiagnosaKlinis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DiagnosaKlinisActionPerformed(evt);
            }
        });
        ...
        jLabel45.setBounds(0, 120, 95, 23);
        ...
        scrollPane18.setViewportView(Kesimpulan);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(100, 120, 625, 150);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("hasil_pemeriksaan_echo","?,?,?,?,?,?","No.Rawat",6,new String[]{
                    TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                    DiagnosaKlinis.getText(),KirimanDari.getText(),Kesimpulan.getText()
                })==true){
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanECHO.jasper","report","::[ Formulir Hasil Pemeriksaan ECHO ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_echo.tanggal,"+
                "hasil_pemeriksaan_echo.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_echo.diagnosa_klinis,hasil_pemeriksaan_echo.kiriman_dari,"+
    ...
    private void DiagnosaKlinisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKlinisKeyPressed
        Valid.pindah(evt,KirimanDari,Kesimpulan);
    ...
    private void KirimanDariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KirimanDariActionPerformed
         //Valid.pindah(evt,DiagnosaKlinis);
    }//GEN-LAST:event_KirimanDariActionPerformed

    private void DiagnosaKlinisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiagnosaKlinisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaKlinisActionPerformed
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kiriman_dari"),rs.getString("diagnosa_klinis"),rs.getString("kesimpulan")
                    });
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_echo","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,kesimpulan=?",7,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),KirimanDari.getText(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){

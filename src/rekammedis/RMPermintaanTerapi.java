 ...
 * @author perpustakaan
 */
public final class RMPermintaanTerapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPermintaanTerapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tanggal","Jam","Dokter","Nama Dokter","NIP","Nama Petugas","Diagnosa","Permintaan","Program"
        }){
        ...
        Diagnosa.setDocument(new batasInput((int)2000).getKata(Diagnosa));
        Permintaan.setDocument(new batasInput((int)2000).getKata(Permintaan));
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){
                    Dokter.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),0).toString());
    ...
    private void initComponents() {
        ...
        Permintaan = new widget.TextArea();
        ...
        MnCatatanKeperawatanRawatJalan.setText("Formulir Permintaan Terapi");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Formulir Permintaan Terapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(320, 320));
        PanelInput.setLayout(new java.awt.BorderLayout(1, 1));

        FormInput.setBackground(new java.awt.Color(250, 255, 245));
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(320, 320));
        ...
        TPasien.setBounds(360, 10, 430, 23);
        ...
        jLabel18.setBounds(10, 90, 70, 23);
        ...
        Dokter.setBounds(130, 90, 104, 23);

        NamaDokter.setEditable(false);
        NamaDokter.setName("NamaDokter"); // NOI18N
        FormInput.add(NamaDokter);
        NamaDokter.setBounds(240, 90, 187, 23);
        ...
        btnPetugas.setBounds(430, 120, 28, 23);
        ...
        TglLahir.setBounds(470, 40, 320, 23);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("Diagnosa :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(10, 160, 60, 23);
        ...
        scrollPane2.setBounds(130, 160, 660, 53);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Permintaan Terapi :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(10, 220, 110, 23);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        Permintaan.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Permintaan.setColumns(20);
        Permintaan.setRows(5);
        ...
        scrollPane3.setViewportView(Permintaan);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(130, 220, 660, 53);
        ...
        jLabel17.setBounds(480, 120, 60, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Petugas :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(10, 120, 70, 23);
        ...
        FormInput.add(NIP);
        NIP.setBounds(130, 120, 104, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(240, 120, 187, 23);
        ...
        btnDokter.setBounds(430, 90, 28, 23);

        Program.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dokter + Terapis", "Dokter", "Terapis" }));
        ...
        Program.setBounds(540, 120, 250, 23);
        ...
        btnDokter1.setBounds(460, 90, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(NIP,"Diagnosa");
        }else if(Permintaan.getText().trim().equals("")){
            Valid.textKosong(NIP,"Permintaan");
        }else{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(NIP.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString())){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptFormulirPermintaanTerapi.jasper","report","::[ Formulir Permintaan Terapi ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam,catatan_permintaan_terapi.diagnosa,catatan_permintaan_terapi.permintaan,catatan_permintaan_terapi.program,"+
                    "petugas.nama,dokter.nm_dokter from catatan_permintaan_terapi inner join reg_periksa on catatan_permintaan_terapi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_permintaan_terapi.nip=petugas.nip inner join dokter on catatan_permintaan_terapi.kd_dokter=dokter.kd_dokter where "+
                    "catatan_permintaan_terapi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam",param);
            }else{
                Valid.MyReportqry("rptFormulirPermintaanTerapi.jasper","report","::[ Formulir Permintaan Terapi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam,catatan_permintaan_terapi.diagnosa,catatan_permintaan_terapi.permintaan,catatan_permintaan_terapi.program,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_permintaan_terapi.nip=petugas.nip inner join dokter on catatan_permintaan_terapi.kd_dokter=dokter.kd_dokter where "+
                    "catatan_permintaan_terapi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    "(reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or catatan_permintaan_terapi.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam ",param);
            }
    ...
    private void MnCatatanKeperawatanRawatJalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanKeperawatanRawatJalanActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirPermintaanTerapi.jasper","report","::[ Formulir Permintaan Terapi ]::",
                    ...
                    "petugas.nama,dokter.nm_dokter from catatan_permintaan_terapi inner join reg_periksa on catatan_permintaan_terapi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_permintaan_terapi.nip=petugas.nip inner join dokter on catatan_permintaan_terapi.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' order by catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam",param);
        }
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        FileName = "LEMBARPROTOKOL_" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().trim() + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().replaceAll("/", "") + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString();
        CreatePDF(FileName);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPermintaanTerapi dialog = new RMPermintaanTerapi(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Permintaan;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam,catatan_permintaan_terapi.kd_dokter,"+
                    "catatan_permintaan_terapi.nip,catatan_permintaan_terapi.diagnosa,catatan_permintaan_terapi.permintaan,catatan_permintaan_terapi.program,petugas.nama,dokter.nm_dokter from catatan_permintaan_terapi inner join reg_periksa on catatan_permintaan_terapi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_permintaan_terapi.nip=petugas.nip inner join dokter on catatan_permintaan_terapi.kd_dokter=dokter.kd_dokter where "+
                    "catatan_permintaan_terapi.tanggal between ? and ? order by catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam ");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam,catatan_permintaan_terapi.kd_dokter,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_permintaan_terapi.nip=petugas.nip inner join dokter on catatan_permintaan_terapi.kd_dokter=dokter.kd_dokter where "+
                    "catatan_permintaan_terapi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_permintaan_terapi.nip like ? or petugas.nama like ?) "+
                    "order by catatan_permintaan_terapi.tanggal,catatan_permintaan_terapi.jam ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tanggal"),rs.getString("jam"),rs.getString("kd_dokter"),rs.getString("nm_dokter"),rs.getString("nip"),rs.getString("nama"),rs.getString("diagnosa"),rs.getString("permintaan"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Permintaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            Program.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_permintaan_terapi","tanggal=? and jam=? and no_rawat=?","no_rawat=?,tanggal=?,jam=?,kd_dokter=?,nip=?,diagnosa=?,permintaan=?,program=?",11,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            Dokter.getText(),NIP.getText(),Diagnosa.getText(),Permintaan.getText(),Program.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),
            ...
            tbObat.setValueAt(Dokter.getText(),tbObat.getSelectedRow(),8);
            tbObat.setValueAt(NamaDokter.getText(),tbObat.getSelectedRow(),9);
            tbObat.setValueAt(NIP.getText(),tbObat.getSelectedRow(),10);
            tbObat.setValueAt(NamaPetugas.getText(),tbObat.getSelectedRow(),11);
            tbObat.setValueAt(Diagnosa.getText(),tbObat.getSelectedRow(),12);
            tbObat.setValueAt(Permintaan.getText(),tbObat.getSelectedRow(),13);
            tbObat.setValueAt(Program.getSelectedItem(),tbObat.getSelectedRow(),14);
            emptTeks();
        }
    }

    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_permintaan_terapi where tanggal=? and jam=? and no_rawat=?",3,new String[]{
    ...
    private void simpan() {
        try {
            if(Sequel.menyimpantf("catatan_permintaan_terapi",
                    "?,?,?,?,?,?,?,?", // tanda tanya sesuai jumlah kolom
                    "Permintaan Terapi", // pesan
                    8, // jumlah parameter
                    new String[]{
                        TNoRw.getText(),
    ...
    private void DataSOAP(){
        if(Sequel.cariInteger("select count(no_rawat) from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' ")>0){
            ...
            Permintaan.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
        }
    ...
    private void CreatePDF(String FileName) {
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
            //param.put("parameter1", ps.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+"")));
            //param.put("parameter1", ps.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+"")));
            Valid.MyReportqry("rptFormulirPermintaanTerapi.jasper", "report", "::[ FORMULIR PERMINTAAN TERAPI ]::", FileName, param);

 ...
 * @author perpustakaan
 */
public final class RMLaporanTindakanParu extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMLaporanTindakanParu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tindakan Thoracosintesis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakLaporanTindakanParu.jasper","report","::[ Laporan Tindakan Medis ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,laporan_tindakan_paru.tanggal,"+
                        "laporan_tindakan_paru.nip,petugas.nama,laporan_tindakan_paru.kd_dokter,dokter.nm_dokter,laporan_tindakan_paru.diagnosa_pra_tindakan,laporan_tindakan_paru.diagnosa_pasca_tindakan,"+
                        "laporan_tindakan_paru.tindakan_medik,laporan_tindakan_paru.uraian,laporan_tindakan_paru.hasil,laporan_tindakan_paru.kesimpulan,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,"+
                        ...
                        "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join laporan_tindakan_paru on reg_periksa.no_rawat=laporan_tindakan_paru.no_rawat "+
                        "inner join dokter on laporan_tindakan_paru.kd_dokter=dokter.kd_dokter inner join petugas on laporan_tindakan_paru.nip=petugas.nip where "+
                        "laporan_tindakan_paru.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' and laporan_tindakan_paru.tanggal='"+tbObat.getValueAt(tbObat.getSelectedRow(),9).toString()+"' ",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMLaporanTindakanParu dialog = new RMLaporanTindakanParu(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,laporan_tindakan_paru.tanggal,"+
                        "laporan_tindakan_paru.nip,petugas.nama,laporan_tindakan_paru.kd_dokter,dokter.nm_dokter,laporan_tindakan_paru.diagnosa_pra_tindakan,laporan_tindakan_paru.diagnosa_pasca_tindakan,"+
                        "laporan_tindakan_paru.tindakan_medik,laporan_tindakan_paru.uraian,laporan_tindakan_paru.hasil,laporan_tindakan_paru.kesimpulan "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join laporan_tindakan_paru on reg_periksa.no_rawat=laporan_tindakan_paru.no_rawat "+
                        "inner join dokter on laporan_tindakan_paru.kd_dokter=dokter.kd_dokter "+
                        "inner join petugas on laporan_tindakan_paru.nip=petugas.nip where "+
                        "laporan_tindakan_paru.tanggal between ? and ? order by laporan_tindakan_paru.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,laporan_tindakan_paru.tanggal,"+
                        "laporan_tindakan_paru.nip,petugas.nama,laporan_tindakan_paru.kd_dokter,dokter.nm_dokter,laporan_tindakan_paru.diagnosa_pra_tindakan,laporan_tindakan_paru.diagnosa_pasca_tindakan,"+
                        ...
                        "inner join dokter on laporan_tindakan_paru.kd_dokter=dokter.kd_dokter "+
                        "inner join petugas on laporan_tindakan_paru.nip=petugas.nip where "+
                        "laporan_tindakan_paru.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "laporan_tindakan_paru.nip like ? or petugas.nama like ?) order by laporan_tindakan_paru.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getlaporan_tindakan_paru());
        BtnHapus.setEnabled(akses.getlaporan_tindakan_paru());
        BtnEdit.setEnabled(akses.getlaporan_tindakan_paru());
        BtnEdit.setEnabled(akses.getlaporan_tindakan_paru());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from laporan_tindakan_paru where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("laporan_tindakan_paru","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,nip=?,diagnosa_pra_tindakan=?,diagnosa_pasca_tindakan=?,tindakan_medik=?,uraian=?,hasil=?,kesimpulan=?",11,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("laporan_tindakan_paru","?,?,?,?,?,?,?,?,?,?","No.Rawat",10,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),
                KdDokter.getText(),KdPetugas.getText(),DiagnosaPraTindakan.getText(),DIagnosaPaskaTindakan.getText(),TindakanMedis.getText(),

...
public final class RMHasilPemeriksaanSpirometri extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanSpirometri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","Kode Dokter","Nama Dokter","Tanggal","Diagnosa Klinis","Kiriman Dari","Hasil Pemeriksaan","Kesimpulan"
            }){
        ...
        Tambahan.setDocument(new batasInput((int)1000).getKata(Tambahan));
    ...
    private void initComponents() {
        ...
        MnPenilaianMedis.setText("Formulir Hasil Pemeriksaan Spirometri");
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-11-2024 00:16:22" }));
        ...
        jLabel30.setBounds(10, 80, 80, 23);
        ...
        jLabel44.setBounds(10, 400, 80, 23);
        ...
        scrollPane17.setBounds(100, 400, 625, 63);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("Pemeriiksaan :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(10, 130, 80, 23);
        ...
        scrollPane18.setViewportView(Pemeriksaan);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(100, 130, 625, 260);
        ...
        BtnDokter1.setBounds(50, 160, 28, 23);

        scrollInput.setViewportView(FormInput);

        internalFrame2.add(scrollInput, java.awt.BorderLayout.CENTER);

        TabRawat.addTab("Input Hasil Pemeriksaan Spirometri", internalFrame2);
        ...
        TabData.addTab("Gambar Pemeriksaan", FormPhoto);
        ...
        TabRawat.addTab("Data Hasil Pemeriksaan Spirometri", internalFrame3);

        internalFrame1.add(TabRawat, java.awt.BorderLayout.CENTER);
        TabRawat.getAccessibleContext().setAccessibleName("Input Hasil Pemeriksaan Spirometri");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataHasilPemeriksaanSPIROMETRI.html");            
                            ...
                            "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA HASIL PEMERIKSAAN SPIROMETRI<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanSpirometri.jasper","report","::[ Formulir Hasil Pemeriksaan Spirometri ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_spirometri.tanggal,"+
                "hasil_pemeriksaan_spirometri.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_spirometri.diagnosa_klinis,hasil_pemeriksaan_spirometri.kiriman_dari,"+
                
                "hasil_pemeriksaan_spirometri.pemeriksaan,hasil_pemeriksaan_spirometri.tambahan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl("hasilpemeriksaanspirometri/login.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                this.setCursor(Cursor.getDefaultCursor()); 
            }else{
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("diagnosa_klinis"),rs.getString("kiriman_dari"),rs.getString("pemeriksaan"),rs.getString("tambahan")
                    });
                }
            } catch (Exception e) {
   ...
   public void otomatispemeriksaan() {
        
        Pemeriksaan.setText("Hasil Pemeriksaan :\n" +
"1. Cardiac Valve : \n" +
"a. Mitral : \n" +
"b. Aorta : \n" +
"c. Tricuspid : \n" +
"d. Pulmonal : \n" +
"\n" +
"2. Dimention of Cardiac Chambers :\n" +
"a. LA : \n" +
"b. LV : \n" +
"c. RV : \n" +
"d. Aorta : \n" +
"\n" +
"3.	LV Systolic Function, EF    % (TEICH)\n" +
"4.	RV Systeolic Function, TAPSE    cm\n" +
"5. Left Ventricular Hypertrophy :\n" +
"6. eRAP :    mmHg\n" +
"7. LV Diastolic Function:E/A");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Pemeriksaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Tambahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_spirometri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,pemeriksaan=?,tambahan=?",8,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),KirimanDari.getText(),Pemeriksaan.getText(),Tambahan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
                ...
                tbObat.setValueAt(Pemeriksaan.getText(),tbObat.getSelectedRow(),9);
                tbObat.setValueAt(Tambahan.getText(),tbObat.getSelectedRow(),10);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select hasil_pemeriksaan_spirometri_gambar.photo from hasil_pemeriksaan_spirometri_gambar where hasil_pemeriksaan_spirometri_gambar.no_rawat=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML2.setText("<html><body><center><a href='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanspirometri/"+rs.getString("photo")+"'><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanspirometri/"+rs.getString("photo")+"' alt='photo' width='550' height='550'/></a></center></body></html>");
                        }  
                    }else{
                        LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
                    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("hasil_pemeriksaan_spirometri","?,?,?,?,?,?,?","No.Rawat",7,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),KirimanDari.getText(),Pemeriksaan.getText(),Tambahan.getText()
            })==true){
                tabMode.addRow(new String[]{

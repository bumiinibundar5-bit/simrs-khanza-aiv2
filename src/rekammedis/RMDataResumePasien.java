...
import rekammedis.MasterCariTemplateResume;
...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,pssoap,psekg,psecho;
    private ResultSet rs,rssoap,rsekg,rsecho;
    private int i=0;
    private DlgCariDokter dokter=new DlgCariDokter(null,false);
    private DlgCariDokter dokterkonsul=new DlgCariDokter(null,false);
    ...
    private RMCariHasilRadiologiUSG cariradiologiusg=new RMCariHasilRadiologiUSG(null,false);
    private RMCariHasilRadiologiECHO cariradiologiecho=new RMCariHasilRadiologiECHO(null,false);
    private RMCariHasilRadiologiEKG cariradiologiekg=new RMCariHasilRadiologiEKG(null,false);
    ...
    private MasterCariTemplateResume template=new MasterCariTemplateResume(null,false);
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        dokterkonsul.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(dokterkonsul.getTable().getSelectedRow()!= -1){
                    KodeDokter1.setText(dokterkonsul.getTable().getValueAt(dokterkonsul.getTable().getSelectedRow(),0).toString());
                    NamaDokter1.setText(dokterkonsul.getTable().getValueAt(dokterkonsul.getTable().getSelectedRow(),1).toString());
        ...
        cariradiologiusg.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariradiologiusg.getTable().getSelectedRow()!= -1){
                    PemeriksaanPenunjang.append(cariradiologiusg.getTable().getValueAt(cariradiologiusg.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanPenunjang.requestFocus();
                }
            }
            @Override
        ...
        cariradiologiekg.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariradiologiekg.getTable().getSelectedRow()!= -1){
                    PemeriksaanPenunjang.append(cariradiologiekg.getTable().getValueAt(cariradiologiekg.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanPenunjang.requestFocus();
                }
            }
            @Override
        ...
        cariradiologiecho.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariradiologiecho.getTable().getSelectedRow()!= -1){
                    PemeriksaanPenunjang.append(cariradiologiecho.getTable().getValueAt(cariradiologiecho.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanPenunjang.requestFocus();
                }
            }
            @Override
        ...
        template.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(template.getTable().getSelectedRow()!= -1){
                    ...
                    JalannyaPenyakit.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),3).toString());
                    DiagnosaUtama.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),4).toString());
                    DiagnosaSekunder1.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),5).toString());
                    ProsedurUtama.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),6).toString());
                    ProsedurSekunder1.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),7).toString());
                    Kondisi.setSelectedItem(template.getTable().getValueAt(template.getTable().getSelectedRow(),8).toString());
                    Obat2an.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),9).toString());
    ...
    private void initComponents() {
        ...
        BtnDokterKonsul = new widget.Button();
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(192, 730));
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 730));

        FormInput.setBackground(new java.awt.Color(250, 255, 245));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 940));
        ...
        jLabel4.setBounds(10, 110, 310, 23);
        ...
        jLabel25.setBounds(10, 610, 130, 23);
        ...
        DiagnosaSekunder2.setBounds(150, 610, 550, 23);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(10, 640, 130, 23);
        ...
        DiagnosaUtama.setBounds(150, 550, 550, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(10, 550, 130, 23);
        ...
        DiagnosaSekunder3.setBounds(150, 640, 550, 23);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(10, 670, 130, 23);
        ...
        DiagnosaSekunder4.setBounds(150, 670, 550, 23);
        ...
        scrollPane2.setBounds(10, 140, 580, 40);
        ...
        jLabel8.setBounds(10, 180, 210, 30);
        ...
        scrollPane6.setBounds(10, 860, 770, 50);
        ...
        jLabel29.setBounds(10, 520, 130, 23);

        jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(10, 580, 130, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 580, 550, 23);
        ...
        jLabel31.setBounds(710, 520, 70, 23);
        ...
        KodeDiagnosaUtama.setBounds(710, 550, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(710, 580, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(710, 610, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(710, 640, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(710, 670, 75, 23);

        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(10, 700, 130, 23);
        ...
        ProsedurUtama.setBounds(150, 700, 550, 23);
        ...
        KodeProsedurUtama.setBounds(710, 700, 75, 23);
        ...
        ProsedurSekunder1.setBounds(150, 730, 550, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(10, 730, 130, 23);
        ...
        KodeProsedurSekunder1.setBounds(710, 730, 75, 23);

        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(10, 760, 130, 23);
        ...
        ProsedurSekunder2.setBounds(150, 760, 550, 23);
        ...
        KodeProsedurSekunder2.setBounds(710, 760, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(710, 790, 75, 23);
        ...
        ProsedurSekunder3.setBounds(150, 790, 550, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(10, 790, 130, 23);
        ...
        jLabel12.setText("Kondisi Pasien  :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(591, 40, 90, 23);
        ...
        BtnDokter1.setBounds(600, 140, 28, 23);

        BtnDokter2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter2.setMnemonic('2');
        BtnDokter2.setText("Hasil Radiologi");
        BtnDokter2.setToolTipText("Alt+2");
        BtnDokter2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnDokter2.setBounds(600, 300, 180, 23);

        // Fitur tarik data USG, ECHO, EKG by ipin.com
        BtnDokter21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter21.setText("Hasil USG");
        BtnDokter21.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnDokter21.setBounds(600, 340, 180, 23);

        BtnDokter22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter22.setText("Hasil ECHO");
        BtnDokter22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnDokter22.setBounds(600, 380, 180, 23);

        BtnDokter23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter23.setText("Hasil EKG");
        BtnDokter23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        BtnDokter3.setBounds(600, 460, 180, 23);
        ...
        BtnDokter4.setBounds(210, 830, 28, 23);
        ...
        BtnDokter5.setBounds(630, 140, 28, 23);
        ...
        BtnDokter6.setBounds(600, 210, 28, 23);
        ...
        BtnTemplateResume.setBounds(560, 40, 28, 23);

        label15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label15.setText("Dokter Konsul :");
        label15.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        ...
        KodeDokter1.setBounds(104, 70, 140, 23);
        ...
        BtnDokterKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokterKonsul.setMnemonic('2');
        BtnDokterKonsul.setToolTipText("Alt+2");
        BtnDokterKonsul.setName("BtnDokterKonsul"); // NOI18N
        BtnDokterKonsul.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnDokterKonsul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDokterKonsulActionPerformed(evt);
            }
        });
        BtnDokterKonsul.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnDokterKonsulKeyPressed(evt);
            }
        });
        FormInput.add(BtnDokterKonsul);
        BtnDokterKonsul.setBounds(520, 70, 28, 23);
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        cariradiologiusg.dispose();
        cariradiologiecho.dispose();
        cariradiologiekg.dispose();
        penyakit.dispose();
        dispose();
    ...
    private void BtnDokter21ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            cariradiologiusg.setNoRawat(TNoRw.getText());
            cariradiologiusg.tampil();
            cariradiologiusg.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariradiologiusg.setLocationRelativeTo(internalFrame1);
            cariradiologiusg.setVisible(true);
        }
    }                                          

    private void BtnDokter22ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            cariradiologiecho.setNoRawat(TNoRw.getText());
            cariradiologiecho.tampil();
            cariradiologiecho.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariradiologiecho.setLocationRelativeTo(internalFrame1);
            cariradiologiecho.setVisible(true);
        }
    }                                          

    private void BtnDokter23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            cariradiologiekg.setNoRawat(TNoRw.getText());
            cariradiologiekg.tampil();
            cariradiologiekg.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariradiologiekg.setLocationRelativeTo(internalFrame1);
            cariradiologiekg.setVisible(true);
        }
    ...
    private void BtnDokterKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterKonsulActionPerformed
        dokterkonsul.emptTeks();
        dokterkonsul.isCek();
        dokterkonsul.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        dokterkonsul.setLocationRelativeTo(internalFrame1);
        dokterkonsul.setVisible(true);
    }//GEN-LAST:event_BtnDokterKonsulActionPerformed

    private void BtnDokterKonsulKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnDokterKonsulKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnDokterKonsulKeyPressed
    ...
    */
    ...
    private widget.Button BtnDokterKonsul;
    ...
    private void isRawat() {
         ...
         }if(Sequel.cariInteger("select count(no_rawat) from hasil_pemeriksaan_ekg where no_rawat='"+TNoRw.getText()+"' ")>0){
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan EKG :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_ekg where no_rawat=?",TNoRw.getText()));
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan Echocardiographi :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_echo where no_rawat=?",TNoRw.getText()));
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan USG :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_usg where no_rawat=?",TNoRw.getText()));
         }if(Sequel.cariInteger("select count(no_rawat) from hasil_pemeriksaan_echo where no_rawat='"+TNoRw.getText()+"' ")>0){
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan Echocardiographi :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_echo where no_rawat=?",TNoRw.getText()));
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan EKG :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_ekg where no_rawat=?",TNoRw.getText()));
         }if(Sequel.cariInteger("select count(no_rawat) from hasil_pemeriksaan_usg where no_rawat='"+TNoRw.getText()+"' ")>0){
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan USG :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_usg where no_rawat=?",TNoRw.getText()));
         }if(Sequel.cariInteger("select count(no_rawat) from hasil_pemeriksaan_usg_gynecologi where no_rawat='"+TNoRw.getText()+"' ")>0){
            PemeriksaanPenunjang.append(Sequel.cariIsi("select concat('Hasil Pemeriksaan USG Gynecologi :\n',kesimpulan,'\n')as kesimpulan from hasil_pemeriksaan_usg_gynecologi where no_rawat=?",TNoRw.getText()));
    ...
    // --- Ambil kode diagnosa ICD ---
    Map<Integer, String> kodeDiagnosa = new HashMap<>();
    Map<Integer, String> namaDiagnosa = new HashMap<>();
    try (PreparedStatement ps = koneksi.prepareStatement(
            "SELECT dp.kd_penyakit, p.nm_penyakit, dp.prioritas FROM diagnosa_pasien dp " +
            "INNER JOIN penyakit p ON dp.kd_penyakit = p.kd_penyakit " +
            "WHERE dp.no_rawat = ? AND dp.status='Ralan' ORDER BY dp.prioritas")) {
        ps.setString(1, norwt);
        try (ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
                int prioritas = rs.getInt("prioritas");
                kodeDiagnosa.put(prioritas, rs.getString("kd_penyakit"));
                namaDiagnosa.put(prioritas, rs.getString("nm_penyakit"));
            }
        }
    } catch (Exception e) {
        System.out.println("Notif Diagnosa ICD: " + e);
    }

    // --- Ambil kode prosedur ICD ---
    Map<Integer, String> kodeProsedur = new HashMap<>();
    Map<Integer, String> deskripsiProsedur = new HashMap<>();
    try (PreparedStatement ps = koneksi.prepareStatement(
            "SELECT pp.kode, icd9.deskripsi_panjang, pp.prioritas FROM prosedur_pasien pp " +
            "INNER JOIN icd9 ON pp.kode = icd9.kode " +
            "WHERE pp.no_rawat = ? ORDER BY pp.prioritas")) {
        ps.setString(1, norwt);
        try (ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
                int prioritas = rs.getInt("prioritas");
                kodeProsedur.put(prioritas, rs.getString("kode"));
                deskripsiProsedur.put(prioritas, rs.getString("deskripsi_panjang"));
            }
        }
    } catch (Exception e) {
        System.out.println("Notif Prosedur ICD: " + e);
    }

    // --- Ambil isi penilaian dan instruksi ---
    String penilaian = "";
    String instruksi = "";
    try (PreparedStatement ps = koneksi.prepareStatement(
            "SELECT penilaian, instruksi FROM pemeriksaan_ralan WHERE no_rawat=? " +
            "ORDER BY tgl_perawatan DESC, jam_rawat DESC LIMIT 1")) {
        ps.setString(1, norwt);
        try (ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
                penilaian = rs.getString("penilaian") != null ? rs.getString("penilaian").trim() : "";
                instruksi = rs.getString("instruksi") != null ? rs.getString("instruksi").trim() : "";
            }
        }
    } catch (Exception e) {
    ...
    // --- Tampilkan Diagnosa ICD (nm_penyakit), abaikan penilaian jika dua-duanya terisi ---
    DiagnosaUtama.setText(namaDiagnosa.getOrDefault(1, ""));
    DiagnosaSekunder1.setText(namaDiagnosa.getOrDefault(2, ""));
    DiagnosaSekunder2.setText(namaDiagnosa.getOrDefault(3, ""));
    DiagnosaSekunder3.setText(namaDiagnosa.getOrDefault(4, ""));
    DiagnosaSekunder4.setText(namaDiagnosa.getOrDefault(5, ""));

    KodeDiagnosaUtama.setText(kodeDiagnosa.getOrDefault(1, ""));
    KodeDiagnosaSekunder1.setText(kodeDiagnosa.getOrDefault(2, ""));
    KodeDiagnosaSekunder2.setText(kodeDiagnosa.getOrDefault(3, ""));
    KodeDiagnosaSekunder3.setText(kodeDiagnosa.getOrDefault(4, ""));
    KodeDiagnosaSekunder4.setText(kodeDiagnosa.getOrDefault(5, ""));

    // --- Tampilkan Prosedur ICD (deskripsi_panjang), abaikan instruksi jika dua-duanya terisi ---
    ProsedurUtama.setText(deskripsiProsedur.getOrDefault(1, ""));
    ProsedurSekunder1.setText(deskripsiProsedur.getOrDefault(2, ""));
    ProsedurSekunder2.setText(deskripsiProsedur.getOrDefault(3, ""));
    ProsedurSekunder3.setText(deskripsiProsedur.getOrDefault(4, ""));

    KodeProsedurUtama.setText(kodeProsedur.getOrDefault(1, ""));
    KodeProsedurSekunder1.setText(kodeProsedur.getOrDefault(2, ""));
    KodeProsedurSekunder2.setText(kodeProsedur.getOrDefault(3, ""));
    KodeProsedurSekunder3.setText(kodeProsedur.getOrDefault(4, ""));

    // Jika penilaian atau instruksi kosong, fallback ke isi penilaian/instruksi
    if (penilaian.length() > 0 && kodeDiagnosa.isEmpty()) {
        String[] splitDiag = penilaian.split("\\s*,\\s*");
        DiagnosaUtama.setText(splitDiag.length > 0 ? splitDiag[0] : "");
        DiagnosaSekunder1.setText(splitDiag.length > 1 ? splitDiag[1] : "");
        DiagnosaSekunder2.setText(splitDiag.length > 2 ? splitDiag[2] : "");
        DiagnosaSekunder3.setText(splitDiag.length > 3 ? splitDiag[3] : "");
        DiagnosaSekunder4.setText(splitDiag.length > 4 ? splitDiag[4] : "");
    }

    if (instruksi.length() > 0 && kodeProsedur.isEmpty()) {
        String[] splitProc = instruksi.split("\\s*,\\s*");
        ProsedurUtama.setText(splitProc.length > 0 ? splitProc[0] : "");
        ProsedurSekunder1.setText(splitProc.length > 1 ? splitProc[1] : "");
        ProsedurSekunder2.setText(splitProc.length > 2 ? splitProc[2] : "");
        ProsedurSekunder3.setText(splitProc.length > 3 ? splitProc[3] : "");
    }
    }
    ...
    private void isForm(){
        ...
        public void isCek2(){
            ...
            if(akses.getjml2()>=1){
                ...
                NamaDokter1.setText(dokterkonsul.tampil3(KodeDokter1.getText()));
                if(NamaDokter1.getText().equals("")){
                    KodeDokter1.setText("");
                    JOptionPane.showMessageDialog(null,"User login bukan dokter...!!");
                }
            }
  ...
  /* 
    //custom22092025
    // helper custom by ChatGPT
    private String mergeText(String lama, String baru){
        if(lama == null) lama = "";
        if(baru == null || baru.trim().equals("")) return lama; 
        if(lama.contains(baru)) return lama; // jika sudah ada, jangan ditambah lagi
        if(lama.trim().equals("")) return baru;
        return lama + "; " + baru; // pakai tanda ; biar rapi
    }
    private void ganti() {
        String diagUtama = DiagnosaUtama.getText();
        String diagSek1  = DiagnosaSekunder1.getText();
        String diagSek2  = DiagnosaSekunder2.getText();
        String diagSek3  = DiagnosaSekunder3.getText();
        String diagSek4  = DiagnosaSekunder4.getText();
        String prosUtama = ProsedurUtama.getText();
        String prosSek1  = ProsedurSekunder1.getText();
        String prosSek2  = ProsedurSekunder2.getText();
        String prosSek3  = ProsedurSekunder3.getText();

        // baca data lama untuk merge
        try {
            ps = koneksi.prepareStatement(
                "SELECT diagnosa_utama, diagnosa_sekunder, diagnosa_sekunder2, diagnosa_sekunder3, diagnosa_sekunder4, " +
            ...
            rs = ps.executeQuery();
            if(rs.next()){
                diagUtama = mergeText(rs.getString("diagnosa_utama"), diagUtama);
                diagSek1  = mergeText(rs.getString("diagnosa_sekunder"), diagSek1);
                diagSek2  = mergeText(rs.getString("diagnosa_sekunder2"), diagSek2);
                diagSek3  = mergeText(rs.getString("diagnosa_sekunder3"), diagSek3);
                diagSek4  = mergeText(rs.getString("diagnosa_sekunder4"), diagSek4);
                prosUtama = mergeText(rs.getString("prosedur_utama"), prosUtama);
                prosSek1  = mergeText(rs.getString("prosedur_sekunder"), prosSek1);
                prosSek2  = mergeText(rs.getString("prosedur_sekunder2"), prosSek2);
                prosSek3  = mergeText(rs.getString("prosedur_sekunder3"), prosSek3);
            }
        } catch(Exception ex){
            System.out.println("Notif ganti merge : "+ex);
        } finally {
        ...
        if(Sequel.mengedittf("resume_pasien","no_rawat=?",
            ...
            new String[]{
                KodeDokter.getText(),
                Keluhan.getText(),
                JalannyaPenyakit.getText(),
                PemeriksaanPenunjang.getText(),
                HasilLaborat.getText(),
                diagUtama, KodeDiagnosaUtama.getText(),
                diagSek1,  KodeDiagnosaSekunder1.getText(),
                diagSek2,  KodeDiagnosaSekunder2.getText(),
                diagSek3,  KodeDiagnosaSekunder3.getText(),
                diagSek4,  KodeDiagnosaSekunder4.getText(),
                prosUtama, KodeProsedurUtama.getText(),
                prosSek1,  KodeProsedurSekunder1.getText(),
                prosSek2,  KodeProsedurSekunder2.getText(),
                prosSek3,  KodeProsedurSekunder3.getText(),
            ...
            tbObat.setValueAt(PemeriksaanPenunjang.getText(),tbObat.getSelectedRow(),9);
            tbObat.setValueAt(HasilLaborat.getText(),tbObat.getSelectedRow(),10);
            tbObat.setValueAt(diagUtama,tbObat.getSelectedRow(),11);
            tbObat.setValueAt(KodeDiagnosaUtama.getText(),tbObat.getSelectedRow(),12);
            tbObat.setValueAt(diagSek1,tbObat.getSelectedRow(),13);
            tbObat.setValueAt(KodeDiagnosaSekunder1.getText(),tbObat.getSelectedRow(),14);
            tbObat.setValueAt(diagSek2,tbObat.getSelectedRow(),15);
            tbObat.setValueAt(KodeDiagnosaSekunder2.getText(),tbObat.getSelectedRow(),16);
            tbObat.setValueAt(diagSek3,tbObat.getSelectedRow(),17);
            tbObat.setValueAt(KodeDiagnosaSekunder3.getText(),tbObat.getSelectedRow(),18);
            tbObat.setValueAt(diagSek4,tbObat.getSelectedRow(),19);
            tbObat.setValueAt(KodeDiagnosaSekunder4.getText(),tbObat.getSelectedRow(),20);
            tbObat.setValueAt(prosUtama,tbObat.getSelectedRow(),21);
            tbObat.setValueAt(KodeProsedurUtama.getText(),tbObat.getSelectedRow(),22);
            tbObat.setValueAt(prosSek1,tbObat.getSelectedRow(),23);
            tbObat.setValueAt(KodeProsedurSekunder1.getText(),tbObat.getSelectedRow(),24);
            tbObat.setValueAt(prosSek2,tbObat.getSelectedRow(),25);
            tbObat.setValueAt(KodeProsedurSekunder2.getText(),tbObat.getSelectedRow(),26);
            tbObat.setValueAt(prosSek3,tbObat.getSelectedRow(),27);
            tbObat.setValueAt(KodeProsedurSekunder3.getText(),tbObat.getSelectedRow(),28);
            tbObat.setValueAt(Obat2an.getText(),tbObat.getSelectedRow(),29);
    ...
    */
       //custom22092025
        private void simpandokterkonsul() {
            if(Sequel.menyimpantf("resume_konsul","?,?","No.Rawat",2,new String[]{
                        KodeDokter1.getText(),TNoRw.getText()
                    })==true){
                        //emptTeks();
            }
        }
    ...
    private void DataEKG(){
            try{
            psekg=koneksi.prepareStatement(
            "select hasil_pemeriksaan_ekg.no_rawat,hasil_pemeriksaan_ekg.kesimpulan from hasil_pemeriksaan_ekg where hasil_pemeriksaan_ekg.no_rawat=?");
            try{
                psekg.setString(1, TNoRw.getText());
                rsekg = psekg.executeQuery();
            if (!rsekg.isBeforeFirst()) { // Jika tidak ada baris hasil
                //JOptionPane.showMessageDialog(null, "Tidak Ada Data SOAP Dokter", "Peringatan", JOptionPane.WARNING_MESSAGE);
            } else {
                while (rsekg.next()) {
                    PemeriksaanPenunjang.append("\nHasil Pemeriksaan EKG :\n"+rsekg.getString("kesimpulan"));
    ...
    private void DataECHO(){
            try{
            psecho=koneksi.prepareStatement(
            "select hasil_pemeriksaan_echo.no_rawat,hasil_pemeriksaan_echo.kesimpulan from hasil_pemeriksaan_echo where hasil_pemeriksaan_echo.no_rawat=?");
            try{
                psecho.setString(1, TNoRw.getText());
                rsecho = psecho.executeQuery();
            if (!rsecho.isBeforeFirst()) { // Jika tidak ada baris hasil
                //JOptionPane.showMessageDialog(null, "Tidak Ada Data SOAP Dokter", "Peringatan", JOptionPane.WARNING_MESSAGE);
            } else {
                while (rsecho.next()) {
                    PemeriksaanPenunjang.append("\nHasil Pemeriksaan Echocardiograpy :\n"+rsecho.getString("kesimpulan"));
                            }
                               }
                           } catch (Exception e) {
                               System.out.println("Notif : " + e);

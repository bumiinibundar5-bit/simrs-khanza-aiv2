 ...
 * @author perpustakaan
 */
public final class RMPenilaianDerajatDehidrasi2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianDerajatDehidrasi2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Penilaian 7","N.P. 7",
            "Penilaian 8","N.P. 8",
            "Penilaian 9","N.P. 9","Total","Hasil Penilaian","Kode Dokter","Nama Dokter"
        }){
    ...
    private void initComponents() {
        ...
        jLabel18.setBounds(390, 40, 60, 23);

        KdDokter.setEditable(false);
        KdDokter.setHighlighter(null);
        KdDokter.setName("KdDokter"); // NOI18N
        FormInput.add(KdDokter);
        KdDokter.setBounds(464, 40, 110, 23);

        NamaDokter.setEditable(false);
        NamaDokter.setName("NamaDokter"); // NOI18N
        FormInput.add(NamaDokter);
        NamaDokter.setBounds(577, 40, 250, 23);
        ...
        btnDokter.setBounds(830, 40, 28, 23);
        ...
        TglLahir.setBounds(689, 10, 170, 23);
        ...
        Skala2.setBounds(140, 120, 260, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("2. Rasa Haus");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(10, 120, 110, 23);
        ...
        Skala3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Normal Sampai Meningkat", "Takikardi Pada Kasus Berat Brakikardi" }));
        ...
        Skala3.setBounds(140, 150, 260, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("3. Denyut Jantung");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(10, 150, 110, 23);
        ...
        Skala4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Normal Sampai Menurun", "Lemah atau Tidak Teraba" }));
        ...
        Skala6.setBounds(575, 90, 230, 23);

        Nilai6.setEditable(false);
        Nilai6.setFocusTraversalPolicyProvider(true);
        Nilai6.setName("Nilai6"); // NOI18N
        FormInput.add(Nilai6);
        Nilai6.setBounds(820, 90, 40, 23);

        jLabel232.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel232.setText("7. Mata");
        jLabel232.setName("jLabel232"); // NOI18N
        FormInput.add(jLabel232);
        jLabel232.setBounds(460, 120, 70, 23);

        Skala7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Sedikit Cekung", "Sangat Cekung" }));
        ...
        jLabel235.setBounds(680, 210, 70, 23);
        ...
        NilaiTotal.setBounds(760, 210, 100, 23);
        ...
        jLabel30.setBounds(10, 240, 120, 23);
        ...
        scrollPane1.setBounds(140, 243, 720, 40);
        ...
        jLabel233.setText("8. Air Mata");
        jLabel233.setName("jLabel233"); // NOI18N
        FormInput.add(jLabel233);
        jLabel233.setBounds(460, 150, 70, 23);

        Skala8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Menurun", "Tidak Ada" }));
        ...
        Skala8.setBounds(575, 150, 230, 23);

        jLabel234.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel234.setText("9. Mulut dan Lidah");
        jLabel234.setName("jLabel234"); // NOI18N
        FormInput.add(jLabel234);
        jLabel234.setBounds(460, 180, 100, 23);

        Skala9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Basah", "Kering", "Pecah-Pecah" }));
        ...
        Skala9.setBounds(575, 180, 230, 23);

        jLabel227.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel227.setText("5. Turgor Kulit");
        jLabel227.setName("jLabel227"); // NOI18N
        FormInput.add(jLabel227);
        jLabel227.setBounds(10, 210, 130, 23);

        Skala5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "< 2 Detik", "> 2 Detik" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianDerajatDehidrasi2 dialog = new RMPenilaianDerajatDehidrasi2(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_dehidrasi_baru.tanggal,"+
                    "penilaian_dehidrasi_baru.penilaian1,penilaian_dehidrasi_baru.penilaian_nilai1,"+
                    "penilaian_dehidrasi_baru.penilaian2,penilaian_dehidrasi_baru.penilaian_nilai2,"+
                    "penilaian_dehidrasi_baru.penilaian3,penilaian_dehidrasi_baru.penilaian_nilai3,"+
                    "penilaian_dehidrasi_baru.penilaian4,penilaian_dehidrasi_baru.penilaian_nilai4,"+
                    "penilaian_dehidrasi_baru.penilaian5,penilaian_dehidrasi_baru.penilaian_nilai5,"+
                    "penilaian_dehidrasi_baru.penilaian6,penilaian_dehidrasi_baru.penilaian_nilai6,"+
                    "penilaian_dehidrasi_baru.penilaian7,penilaian_dehidrasi_baru.penilaian_nilai7,"+
                    "penilaian_dehidrasi_baru.penilaian8,penilaian_dehidrasi_baru.penilaian_nilai8,"+
                    "penilaian_dehidrasi_baru.penilaian9,penilaian_dehidrasi_baru.penilaian_nilai9,"+
                    "penilaian_dehidrasi_baru.penilaian_totalnilai,penilaian_dehidrasi_baru.hasil_penilaian,"+
                    "penilaian_dehidrasi_baru.kd_dokter,dokter.nm_dokter "+
                    "from penilaian_dehidrasi_baru inner join reg_periksa on penilaian_dehidrasi_baru.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on penilaian_dehidrasi_baru.kd_dokter=dokter.kd_dokter where "+
                    "penilaian_dehidrasi_baru.tanggal between ? and ? order by penilaian_dehidrasi_baru.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_dehidrasi_baru.tanggal,"+
                    "penilaian_dehidrasi_baru.penilaian1,penilaian_dehidrasi_baru.penilaian_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on penilaian_dehidrasi_baru.kd_dokter=dokter.kd_dokter where "+
                    "penilaian_dehidrasi_baru.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_dehidrasi_baru.kd_dokter like ? or dokter.nm_dokter like ?) "+
                    "order by penilaian_dehidrasi_baru.tanggal ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("penilaian9"),rs.getString("penilaian_nilai9"),rs.getString("penilaian_totalnilai"),rs.getString("hasil_penilaian"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            NilaiTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            HasilPenilaian.setText(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_dehidrasi_baru","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian1=?,penilaian_nilai1=?,"+
                ...
                "penilaian7=?,penilaian_nilai7=?,penilaian8=?,penilaian_nilai8=?,"+
                "penilaian9=?,penilaian_nilai9=?,"+
                "penilaian_totalnilai=?,hasil_penilaian=?,kd_dokter=?",25,new String[]{
                ...
                Skala9.getSelectedItem().toString(),Nilai9.getText(),
            ...
            tbObat.setValueAt(NilaiTotal.getText(),tbObat.getSelectedRow(),24);
            tbObat.setValueAt(HasilPenilaian.getText(),tbObat.getSelectedRow(),25);
            tbObat.setValueAt(KdDokter.getText(),tbObat.getSelectedRow(),26);
            tbObat.setValueAt(NamaDokter.getText(),tbObat.getSelectedRow(),27);
            emptTeks();
        }
    }

    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_dehidrasi_baru where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalDerajat() {
            try {
                double total = Double.parseDouble(Nilai1.getText())
                             + Double.parseDouble(Nilai2.getText())
                             + Double.parseDouble(Nilai3.getText())
                             + Double.parseDouble(Nilai4.getText())
                             + Double.parseDouble(Nilai5.getText())
                             + Double.parseDouble(Nilai6.getText())
                             + Double.parseDouble(Nilai7.getText())
                             + Double.parseDouble(Nilai8.getText())
                             + Double.parseDouble(Nilai9.getText());

                double i = total / 9; // menghitung rata-rata dari 9 nilai

                NilaiTotal.setText(String.format("%.2f", i));
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_dehidrasi_baru","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",23,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            Skala1.getSelectedItem().toString(),Nilai1.getText(),Skala2.getSelectedItem().toString(),Nilai2.getText(),
            Skala3.getSelectedItem().toString(),Nilai3.getText(),Skala4.getSelectedItem().toString(),Nilai4.getText(), 
            Skala5.getSelectedItem().toString(),Nilai5.getText(),Skala6.getSelectedItem().toString(),Nilai6.getText(),

...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
        ...
        cariradiologiusg.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariradiologiusg.getTable().getSelectedRow()!= -1){
                    PemeriksaanRad.append(cariradiologiusg.getTable().getValueAt(cariradiologiusg.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanRad.requestFocus();
                }
            }
            @Override
        ...
        cariradiologiekg.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariradiologiekg.getTable().getSelectedRow()!= -1){
                    PemeriksaanRad.append(cariradiologiekg.getTable().getValueAt(cariradiologiekg.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanRad.requestFocus();
                }
            }
            @Override
        ...
        cariradiologiecho.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariradiologiecho.getTable().getSelectedRow()!= -1){
                    PemeriksaanRad.append(cariradiologiecho.getTable().getValueAt(cariradiologiecho.getTable().getSelectedRow(),1).toString()+", ");
                    PemeriksaanRad.requestFocus();
                }
            }
            @Override
    ...
    private void initComponents() {
        ...
        // Fitur tarik data USG, ECHO, EKG by arwildo.com
        ...
        BtnDokter21.setBounds(800, 340, 180, 23);
        ...
        BtnDokter22.setBounds(800, 380, 180, 23);
        ...
        BtnDokter23.setBounds(1000, 340, 180, 23);
    ...
    private void BtnDokter21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
    ...
    private void BtnDokter22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{

...
public class SuratKonsul extends javax.swing.JDialog {
    ...
    public SuratKonsul(java.awt.Frame parent, boolean modal) {
        ...
        "Kode Poli Tujuan","Nama Poli Tujuan","Umur","Tujuan Konsul","Status","Isi Konsul","Tanggal Jawaban","Jawaban Konsul"
            }){
  ...
  //          }
    ...
    private void initComponents() {
        ...
        MnPenilaianMedis.setText("Cetak Lembar Konsultasi");
        ...
        Scroll.setPreferredSize(new java.awt.Dimension(452, 1000));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2024" }));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(190, 150));
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(150, 10, 87, 23);

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("Dokter:");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(20, 100, 100, 23);
        ...
        NmDokterTujuan.setBounds(150, 100, 260, 23);

        TPasien.setEditable(false);
        TPasien.setHighlighter(null);
        TPasien.setName("TPasien"); // NOI18N
        FormInput.add(TPasien);
        TPasien.setBounds(240, 10, 300, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2024 03:35:27" }));
        ...
        TanggalSurat.setBounds(680, 40, 140, 23);
        ...
        Status.setBounds(690, 130, 130, 23);

        jLabel10.setText("Tanggal Surat :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(590, 40, 80, 23);
        ...
        KdDokterTujuan.setBounds(60, 100, 87, 23);
        ...
        BtnDokter.setBounds(410, 100, 28, 23);

        jLabel37.setText("Status :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(630, 130, 50, 23);

        jLabel11.setText("Unit/Poli dituju :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(430, 100, 90, 23);
        ...
        KdPoliTujuan.setBounds(530, 100, 70, 23);
        ...
        NmPoliTujuan.setBounds(610, 100, 190, 23);
        ...
        NoSurat.setBounds(620, 10, 200, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("JAWABAN KONSUL");
        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(20, 240, 220, 23);
        ...
        TglLahir.setBounds(100, 40, 90, 23);

        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel19.setText("Tanggal Lahir:");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(20, 40, 80, 23);

        jLabel20.setText("Umur:");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(340, 40, 40, 23);
        ...
        FormInput.add(Umur);
        Umur.setBounds(390, 40, 80, 23);

        jLabel21.setText("Jenis Kelamin :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(200, 40, 70, 23);
        ...
        KdDokterPerujuk.setBounds(110, 70, 70, 23);
        ...
        NmDokterPerujuk.setBounds(190, 70, 230, 23);
        ...
        BtnDokter1.setBounds(420, 70, 20, 23);
        ...
        scrollPane9.setBounds(20, 160, 800, 50);

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel14.setText("Mohon bantuan sejawat untuk:");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(20, 130, 160, 23);
        ...
        TujuanKonsul.setBounds(180, 130, 430, 20);
        ...
        NmPoliAsal.setBounds(600, 70, 200, 23);
        ...
        BtnPoli1.setBounds(800, 70, 28, 23);

        TanggalJawaban.setForeground(new java.awt.Color(50, 70, 50));
        TanggalJawaban.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2024 03:35:28" }));
        ...
        TanggalJawaban.setBounds(650, 240, 170, 20);

        jLabel28.setText("Tanggal Jawaban Konsultasi :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(460, 240, 180, 23);
        ...
        BtnSimpan1.setBounds(680, 390, 140, 30);
        ...
        if(tabMode.getRowCount()==0){
           ...
           JOptionPane.showMessageDialog(null,"Surat konsul tidak bisa dihapus karena sudah dijawab");
            ...
            JOptionPane.showMessageDialog(null,"Maaf, Gagal menghapus. Pilih dulu data yang mau dihapus.\nKlik data pada table untuk memilih...!!!!");
                ...
                if(NoSurat.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),3).toString())==true){
   ...
   // BtnSimpan.setEnabled(akses.getadmin());
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),6).toString():finger)+"\n"+Valid.SetTgl2(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString()));

            Valid.MyReportqry("rptCetakLembarKonsultasi.jasper","report","::[ Lembar Konsultasi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,surat_konsul.tanggalsurat,"+
		"surat_konsul.kd_dokter_perujuk,surat_konsul.dokterperujuk,surat_konsul.kd_poli_perujuk,surat_konsul.poliperujuk,"+
		"surat_konsul.kd_dokter_tujuan,surat_konsul.doktertujuan,surat_konsul.kd_poli_tujuan,surat_konsul.politujuan,"+
		"surat_konsul.umur,surat_konsul.tujuan_konsul,surat_konsul.status,surat_konsul.isikonsul,surat_konsul.tanggaljawaban,"+
		"surat_konsul.jawabankonsul from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join surat_konsul on reg_periksa.no_rawat=surat_konsul.no_rawat "+
 		"inner join dokter on surat_konsul.kd_dokter_perujuk=dokter.kd_dokter where surat_konsul.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
        ...
        try {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    rs.getString("tanggaljawaban"),rs.getString("jawabankonsul")
                    });                    
                }
            } catch (Exception e) {

 ...
 */
public final class SuratPernyataanKronologis extends javax.swing.JDialog {
    ...
    private String finger="",lokasifile="",FileName = "", kodeberkas = "";
    
    public SuratPernyataanKronologis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tempat Lahir P.J.","Tgl.Lahir P.J.","Hubungan","J.K. P.J.","Nomor Telp/HP","Nomor KTP","Alamat P.J.","NIP","Nama Petugas","Kronologis"
        }){
    ...
    private void initComponents() {
        ...
        BtnUploadSPRI = new widget.Button();
        ...
        Kronologis = new widget.TextArea();
        ...
        BtnUploadSPRI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/editcopy.png"))); // NOI18N
        BtnUploadSPRI.setMnemonic('K');
        BtnUploadSPRI.setText("Upload");
        BtnUploadSPRI.setToolTipText("Alt+K");
        BtnUploadSPRI.setName("BtnUploadSPRI"); // NOI18N
        BtnUploadSPRI.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnUploadSPRI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnUploadSPRIActionPerformed(evt);
            }
        });
        BtnUploadSPRI.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnUploadSPRIKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnUploadSPRI);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2025" }));
        ...
        jLabel8.setBounds(10, 140, 100, 23);
        ...
        NamaPJ.setBounds(100, 110, 260, 23);

        jLabel9.setText("Jenis Kelamin :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(220, 140, 80, 23);
        ...
        FormInput.add(JKPJ);
        JKPJ.setBounds(310, 140, 110, 23);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel10.setText("Nama :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(10, 110, 100, 23);

        jLabel11.setText("Alamat :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(260, 170, 55, 23);
        ...
        Hubungan.setBounds(100, 140, 110, 23);
        ...
        AlamatPj.setBounds(320, 170, 420, 23);
        ...
        jLabel16.setBounds(10, 40, 60, 23);

        TglLahir.setForeground(new java.awt.Color(50, 70, 50));
        TglLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2025" }));
        ...
        TglLahir.setBounds(650, 110, 90, 23);

        jLabel44.setText("Tempat/Tanggal Lahir :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(370, 110, 120, 23);
        ...
        TempatLahir.setBounds(500, 110, 140, 23);
        ...
        jLabel14.setBounds(0, 80, 154, 23);
        ...
        jLabel15.setBounds(10, 170, 100, 23);
        ...
        FormInput.add(NoKTP);
        NoKTP.setBounds(100, 170, 160, 23);
        ...
        NoTelp.setBounds(580, 140, 160, 23);

        jLabel20.setText("Nomor Telp/Nomor HP :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(440, 140, 120, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kronologis Kejadian :");
        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(10, 210, 110, 23);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        Kronologis.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        scrollPane3.setViewportView(Kronologis);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(10, 240, 730, 180);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_pernyataan_pasien_kronologis","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
                    ...
                    AlamatPj.getText(),Hubungan.getSelectedItem().toString(),NoTelp.getText(),NIP.getText(),Kronologis.getText()
                })==true){
                tabMode.addRow(new String[]{
                    ...
                    AlamatPj.getText(),NIP.getText(),NamaPetugas.getText(),Kronologis.getText()
                });
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                Sequel.queryu("delete from antripernyataankronologis");
                Sequel.queryu("insert into antripernyataankronologis values('"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"','"+tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()+"')");
                Sequel.queryu("delete from surat_pernyataan_pasien_kronologis_pembuat_pernyataan where no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'");
            }else{
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(lokasifile.equals("")){
                ...
                param.put("emailrs",akses.getemailrs());
                param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                param.put("photo","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pernyataankronologis/"+lokasifile);
                ...
                Valid.MyReportqry("rptSuratPernyataanKronologis.jasper","report","::[ Surat Pernyataan Kronologis ]::",
                    "select surat_pernyataan_pasien_kronologis.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,pasien.pekerjaan,pasien.tmp_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat,reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pasien_kronologis.tanggal,surat_pernyataan_pasien_kronologis.nama_pj,"+
		    "surat_pernyataan_pasien_kronologis.no_ktppj,surat_pernyataan_pasien_kronologis.tempat_lahirpj,surat_pernyataan_pasien_kronologis.lahirpj,surat_pernyataan_pasien_kronologis.jkpj,surat_pernyataan_pasien_kronologis.alamatpj,surat_pernyataan_pasien_kronologis.hubungan,surat_pernyataan_pasien_kronologis.no_telp,surat_pernyataan_pasien_kronologis.nip,surat_pernyataan_pasien_kronologis.kronologis,petugas.nama from surat_pernyataan_pasien_kronologis inner join reg_periksa on surat_pernyataan_pasien_kronologis.no_rawat=reg_periksa.no_rawat "+
		    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on surat_pernyataan_pasien_kronologis.nip=petugas.nip inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                    "where surat_pernyataan_pasien_kronologis.no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
            }
        }else{
    ...
    private void BtnUploadSPRIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadSPRIActionPerformed
        Random rand = new Random();
        int randomNumber = rand.nextInt(100) + 1;
        FileName = randomNumber + "KRONOLOGIS_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().replaceAll("/", "") + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 3).toString();
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        UploadPDF(FileName, "berkasrawat/pages/upload/");
        HapusPDF();
    }//GEN-LAST:event_BtnUploadSPRIActionPerformed

    private void BtnUploadSPRIKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnUploadSPRIKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnUploadSPRIKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPernyataanKronologis dialog = new SuratPernyataanKronologis(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnUploadSPRI;
    ...
    private widget.TextArea Kronologis;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select surat_pernyataan_pasien_kronologis.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pasien_kronologis.tanggal,surat_pernyataan_pasien_kronologis.nama_pj,"+
                    "surat_pernyataan_pasien_kronologis.no_ktppj,surat_pernyataan_pasien_kronologis.tempat_lahirpj,surat_pernyataan_pasien_kronologis.lahirpj,"+
                    "surat_pernyataan_pasien_kronologis.jkpj,surat_pernyataan_pasien_kronologis.alamatpj,surat_pernyataan_pasien_kronologis.hubungan,"+
                    "surat_pernyataan_pasien_kronologis.no_telp,surat_pernyataan_pasien_kronologis.nip,surat_pernyataan_pasien_kronologis.kronologis,petugas.nama from surat_pernyataan_pasien_kronologis "+
                    "inner join reg_periksa on surat_pernyataan_pasien_kronologis.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pasien_kronologis.nip=petugas.nip where "+
                    "surat_pernyataan_pasien_kronologis.tanggal between ? and ? order by surat_pernyataan_pasien_kronologis.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select surat_pernyataan_pasien_kronologis.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pasien_kronologis.tanggal,surat_pernyataan_pasien_kronologis.nama_pj,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_pernyataan_pasien_kronologis.nip=petugas.nip where "+
                    "surat_pernyataan_pasien_kronologis.tanggal between ? and ? and "+
                    "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                    "surat_pernyataan_pasien_kronologis.alamatpj like ? or surat_pernyataan_pasien_kronologis.nama_pj like ? or "+
                    "surat_pernyataan_pasien_kronologis.nip like ? or petugas.nama like ?) "+
                    "order by surat_pernyataan_pasien_kronologis.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("alamatpj"),rs.getString("nip"),rs.getString("nama"),rs.getString("kronologis") 
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_pernyataan_pasien_umum.no_surat,3),signed)),0) from surat_pernyataan_pasien_umum where surat_pernyataan_pasien_umum.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
                "PPK"+Tanggal.getSelectedItem().toString().substring(6,10)+Tanggal.getSelectedItem().toString().substring(3,5)+Tanggal.getSelectedItem().toString().substring(0,2),3,NoSurat);
        NamaPJ.requestFocus();
    }
    ...
    private void getData() {
         if(tbObat.getSelectedRow()!= -1){
            ...
            Kronologis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString()); 
    ...
    private void ganti() {
        if(Sequel.mengedittf("surat_pernyataan_pasien_kronologis","no_surat=?","no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,no_ktppj=?,tempat_lahirpj=?,lahirpj=?,jkpj=?,alamatpj=?,hubungan=?,no_telp=?,nip=?,kronologis=?",14,new String[]{
            NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),NamaPJ.getText(),NoKTP.getText(),
            TempatLahir.getText(),Valid.SetTgl(TglLahir.getSelectedItem()+""),JKPJ.getSelectedItem().toString().substring(0,1),
            AlamatPj.getText(),Hubungan.getSelectedItem().toString(),NoTelp.getText(),NIP.getText(),Kronologis.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
            ...
            tbObat.setValueAt(Kronologis.getText(),tbObat.getSelectedRow(),18);
            emptTeks();
        }
    }

    private void hapus() {
        if(Sequel.queryu2tf("delete from surat_pernyataan_pasien_kronologis where no_surat=?",1,new String[]{
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            lokasifile="";
            try {
                ps=koneksi.prepareStatement("select surat_pernyataan_pasien_kronologis_pembuat_pernyataan.photo from surat_pernyataan_pasien_kronologis_pembuat_pernyataan where surat_pernyataan_pasien_kronologis_pembuat_pernyataan.no_surat=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pernyataankronologis/"+rs.getString("photo")+"' alt='photo' width='500' height='500'/></center></body></html>");
                        }  
                    }else{
                        lokasifile="";
                        LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
        ...
        if (tabMode.getRowCount() == 0) {
          ...
          if(tbObat.getSelectedRow()>-1){
            if(lokasifile.equals("")){
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),17).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),16).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()));
                Valid.MyReportPDFqryUpload("rptSuratPernyataanKronologis.jasper","report","::[ Surat Pernyataan Kronologis ]::",
                    "select surat_pernyataan_pasien_kronologis.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,pasien.pekerjaan,pasien.tmp_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat,reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_pernyataan_pasien_kronologis.tanggal,surat_pernyataan_pasien_kronologis.nama_pj,"+
		    "surat_pernyataan_pasien_kronologis.no_ktppj,surat_pernyataan_pasien_kronologis.tempat_lahirpj,surat_pernyataan_pasien_kronologis.lahirpj,surat_pernyataan_pasien_kronologis.jkpj,surat_pernyataan_pasien_kronologis.alamatpj,surat_pernyataan_pasien_kronologis.hubungan,surat_pernyataan_pasien_kronologis.no_telp,surat_pernyataan_pasien_kronologis.nip,surat_pernyataan_pasien_kronologis.kronologis,petugas.nama from surat_pernyataan_pasien_kronologis inner join reg_periksa on surat_pernyataan_pasien_kronologis.no_rawat=reg_periksa.no_rawat "+
		    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on surat_pernyataan_pasien_kronologis.nip=petugas.nip inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                    "where surat_pernyataan_pasien_kronologis.no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' ",FileName, param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }else{
            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data terlebih dahulu..!!!!");
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%KRONOLOGIS%'");

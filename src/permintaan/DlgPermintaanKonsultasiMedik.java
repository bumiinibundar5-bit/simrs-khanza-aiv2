...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    */
    ...
    //ipinmodikonsultasiMedik
public void isCek(){
    // default nonaktif
    BtnSimpan.setEnabled(false);
    BtnHapus.setEnabled(false);
    BtnPrint.setEnabled(false);
    BtnJawabanDikonsuli.setEnabled(false);
    ...
    if(akses.getadmin()==true){
        ...
        BtnJawabanDikonsuli.setEnabled(true);
        BtnRiwayatPasien.setEnabled(true);
        BtnEdit.setEnabled(true);
    }

    // Jika Dokter (akses.getjml2()>=1 artinya user dokter)
    if(akses.getjml2()>=1){
        BtnSimpan.setEnabled(true);
        BtnHapus.setEnabled(true);
        BtnPrint.setEnabled(true);
        ...
        // lock data dokter biar gak bisa diubah manual
        KdDokter.setEditable(false);

...
import simrskhanza.DlgInputObatOperasi;
...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    public DlgBookingOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Kode Operator","Operator","Order","Kode","R.Operasi","No.RM","Tanggal Lahir","Alamat"
            }){
    ...
    private void initComponents() {
		...
		BtnInputObatOperasi = new widget.Button();
        ...
        BtnBukaSOAP = new widget.Button();
        BtnBukaSOAP.setIcon(new javax.swing.ImageIcon(
            getClass().getResource("/picture/save-16x16.png")
        ));
        BtnBukaSOAP.setMnemonic('O');
        BtnBukaSOAP.setText("Buka SOAP");
        BtnBukaSOAP.setToolTipText("Alt+O");
        BtnBukaSOAP.setName("BtnBukaSOAP");
        BtnBukaSOAP.setPreferredSize(new java.awt.Dimension(120, 30));
        BtnBukaSOAP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBukaSOAPActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnBukaSOAP);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2024" }));
		...
		BtnInputObatOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInputObatOperasi.setText("Input Obat dan BHP Operasi");
        BtnInputObatOperasi.setFocusPainted(false);
        BtnInputObatOperasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputObatOperasi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInputObatOperasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputObatOperasi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInputObatOperasi.setName("BtnInputObatOperasi"); // NOI18N
        BtnInputObatOperasi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInputObatOperasi.setRoundRect(false);
        BtnInputObatOperasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputObatOperasiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInputObatOperasi);
        ...
        BtnKonsultasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKonsultasi.setText("Konsultasi Spesialis");
        BtnKonsultasi.setFocusPainted(false);
        BtnKonsultasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
    ...
    //EVENT BUTTON (tetap punyamu, hanya koreksi kecil)
        private void BtnBukaSOAPActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    String norawat = tbObat.getValueAt(row, 1).toString(); // No.Rawat
    bukaSOAPBooking(norawat);
}
//25-01-2026//
private void bukaSOAPBooking(String norawat) {
    try {
        ...
        if (status.equalsIgnoreCase("Ralan")) {
            ...
            DlgRawatJalan rj = new DlgRawatJalan(null, false);
            rj.bukaDariBookingOperasi(norawat); //
            rj.setSize(screen);
            rj.setLocationRelativeTo(null);   
            rj.setVisible(true);
            setTabPemeriksaan(rj);

        } else if (status.equalsIgnoreCase("Ranap")) {

            DlgRawatInap ri = new DlgRawatInap(null, false);
            ri.bukaDariBookingOperasi(norawat); //
            ri.setSize(screen);
            ...
            JOptionPane.showMessageDialog(null,
                "Status perawatan tidak dikenali");
        }
...
//25-01-2026//
// TAMBAHAN SAJA ini menuju langsung tb pemerikssan jika eror hapus saja 
    private void setTabPemeriksaan(java.awt.Container container) {
        for (java.awt.Component c : container.getComponents()) {
            if (c instanceof javax.swing.JTabbedPane) {
                javax.swing.JTabbedPane tab = (javax.swing.JTabbedPane) c;
                for (int i = 0; i < tab.getTabCount(); i++) {
                    if ("Pemeriksaan".equalsIgnoreCase(tab.getTitleAt(i))) {
            ...
            if (c instanceof java.awt.Container) {
                setTabPemeriksaan((java.awt.Container) c);
            }
        }
    } 
// TAMBAHAN SAJA ini menuju langsung tb pemerikssan jika eror hapus saja 
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
	...
	private void BtnInputObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTagihanOperasiActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{            
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                    ...
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    DlgInputObatOperasi dlgro=new DlgInputObatOperasi(null,false);
    ...
    private void BtnKonsultasiActionPerformed(java.awt.event.ActionEvent evt) {                                              
       if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            if(tbObat.getSelectedRow()!= -1){
                ...
                form.emptTeks();
                norm=Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText());
                form.setNoRm2(TNoRw.getText(),norm,TPasien.getText(),KdDokter.getText(),NmDokter.getText());
    ...
    */
    ...
    private widget.Button BtnBukaSOAP;
	...
	private widget.Button BtnInputObatOperasi;
    ...
    public void tampil() {     
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "pasien.jk,pasien.tgl_lahir,pasien.alamat,pasien.no_rkm_medis,poliklinik.nm_poli,booking_operasi.kd_ruang_ok,ruang_ok.nm_ruang_ok "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    diagnosa=Sequel.cariIsi("select diagnosa_awal from kamar_inap where kamar_inap.no_rawat=? limit 1",rs.getString("no_rawat"));
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nm_ruang_ok"),rs.getString("no_rkm_medis"),rs.getString("tgl_lahir"),rs.getString("alamat")
                    });
                    i++;
                }
            } catch (Exception e) {
	...
	BtnInputObatOperasi.setVisible(akses.getoperasi());

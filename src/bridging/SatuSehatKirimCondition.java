    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "reg_periksa.stts,reg_periksa.status_lanjut,mutasi_berkas.kembali as pulang,satu_sehat_encounter.id_encounter, "+
            ...
            ps=koneksi.prepareStatement(
                   "select reg_periksa.tgl_registrasi,reg_periksa.jam_reg,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,"+
                   "reg_periksa.stts,reg_periksa.status_lanjut,concat(kamar_inap.tgl_keluar,' ',kamar_inap.jam_keluar) as pulang,satu_sehat_encounter.id_encounter, "+
                   "diagnosa_pasien.kd_penyakit,penyakit.nm_penyakit,ifnull(satu_sehat_condition.id_condition,'') as id_condition "+

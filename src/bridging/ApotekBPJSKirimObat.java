...
//                }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Obat Apotek BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel8.setBounds(420, 40, 80, 23);

        Jam.setEditable(false);
        Jam.setHighlighter(null);
        Jam.setName("Jam"); // NOI18N
        FormInput.add(Jam);
        Jam.setBounds(660, 70, 120, 24);

        DTPTgl.setForeground(new java.awt.Color(50, 70, 50));
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-10-2025" }));
        ...
        LblNoRawat.setBounds(90, 10, 120, 23);

        TanggalPelayanan.setForeground(new java.awt.Color(50, 70, 50));
        TanggalPelayanan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-10-2025" }));
        ...
        TanggalPelayanan.setBounds(510, 70, 90, 23);
        ...
        jLabel20.setBounds(420, 70, 80, 23);

        NmPoli.setEditable(false);
        NmPoli.setHighlighter(null);
        NmPoli.setName("NmPoli"); // NOI18N
        FormInput.add(NmPoli);
        NmPoli.setBounds(180, 130, 220, 23);

        KdPoli.setEditable(false);
        KdPoli.setHighlighter(null);
        KdPoli.setName("KdPoli"); // NOI18N
        FormInput.add(KdPoli);
        KdPoli.setBounds(90, 130, 80, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Asal Poliklinik :");
        ...
        jLabel15.setBounds(10, 100, 70, 23);

        KdDPJP.setEditable(false);
        KdDPJP.setHighlighter(null);
        KdDPJP.setName("KdDPJP"); // NOI18N
        FormInput.add(KdDPJP);
        KdDPJP.setBounds(90, 100, 80, 23);

        NmDPJP.setEditable(false);
        NmDPJP.setHighlighter(null);
        NmDPJP.setName("NmDPJP"); // NOI18N
        FormInput.add(NmDPJP);
        NmDPJP.setBounds(180, 100, 220, 23);
        ...
        TResep.setBounds(320, 70, 80, 23);

        Iterasi.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        Iterasi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0. Tanpa Iterasi", "1. Dengan Iterasi 1 Kali", "2. Dengan Iterasi 2 Kali" }));
        Iterasi.setName("Iterasi"); // NOI18N
        FormInput.add(Iterasi);
        Iterasi.setBounds(510, 130, 270, 20);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("Iterasi :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(420, 130, 50, 20);

        JnsObat.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        ...
        JnsObat.setBounds(510, 100, 270, 24);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Jenis Obat :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(420, 100, 80, 23);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("No. JKN :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(10, 70, 60, 23);
...
if(TNoRw.getText().trim().equals("")){
    ...
    if (reply == JOptionPane.YES_OPTION) {
        try {  
            ...
            // LANGSUNG BUAT RESEP BARU (tanpa pengecekan)
            URL = link + "/sjpresep/v3/insert";
            System.out.println(URL);
            requestJson = "{"
                    + "\"TGLSJP\": \"" + Valid.SetTgl(DTPTgl.getSelectedItem()+"")+" "
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (Sequel.menyimpantf2("bridging_apotek_bpjs", "?,?,?,?,?,?,?,?,?,?,?,?", "data", 12,
                    ...
                    JOptionPane.showMessageDialog(null, 
                        //"Resep Apotek "+response.path("noApotik").asText()+" Berhasil disimpan ");
                        "Resep Apotek "+nameNode.path("message").asText()+" Berhasil disimpan ");
                    
                    // === KONFIRMASI LANJUT KIRIM OBAT ===
int lanjut = JOptionPane.showConfirmDialog(
        null,
        "Nomor Resep berhasil dibuat.\nApakah ingin melanjutkan pengiriman obat?",
        "Konfirmasi Pengiriman Obat",
        JOptionPane.YES_NO_OPTION
);

// Jika TIDAK → STOP di sini
if (lanjut != JOptionPane.YES_OPTION) {
    System.out.println("Pengiriman obat dibatalkan, hanya nomor resep dibuat");
    return; // keluar dari proses obat
}
...
for (i = 0; i < tbObat.getRowCount(); i++) { 
    if (Valid.SetAngka(tbObat.getValueAt(i, 1).toString()) > 0) {   
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                boolean sukses = Sequel.menyimpantf("bridging_apotek_bpjs_obat", "?,?,?,?,?,?,?,?,?", 
                    "Simpan Obat Apotek BPJS", 9, new String[]{
                        response.path("noSep_Kunjungan").asText(),
                        TResep.getText(),
                ...
                JOptionPane.showMessageDialog(null, 
                    "Obat Gagal Disimpan, " + nameNode.path("message").asText());
            }
        } catch (Exception ex) {
...
int lanjutKirimObat = JOptionPane.showConfirmDialog(
        null,
        "Nomor Resep berhasil dibuat.\nApakah ingin melanjutkan pengiriman obat?",
        "Konfirmasi Pengiriman Obat",
        JOptionPane.YES_NO_OPTION
...
// Jika TIDAK → STOP TOTAL
if (lanjutKirimObat != JOptionPane.YES_OPTION) {
    System.out.println("Pengiriman obat dibatalkan, hanya nomor resep dibuat");
    return;
}
...
for (i = 0; i < tbDetailObatRacikan.getRowCount(); i++) { 
    if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 1).toString()) > 0) {
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                boolean sukses = Sequel.menyimpantf("bridging_apotek_bpjs_obat", "?,?,?,?,?,?,?,?,?", 
                    "Simpan Obat Apotek BPJS Racikan", 9, new String[]{
                        response.path("noSep_Kunjungan").asText(),
                        TResep.getText(),
                ...
                if (sukses) {
                    System.out.println("Obat racikan " + tbDetailObatRacikan.getValueAt(i, 3).toString() + " Berhasil disimpan");
                    JOptionPane.showMessageDialog(null, 
                        "Obat racikan " + tbDetailObatRacikan.getValueAt(i, 3).toString() + " Berhasil disimpan");
                }
            } else {
                JOptionPane.showMessageDialog(null, 
                    "Obat Gagal Disimpan, " + nameNode.path("message").asText());

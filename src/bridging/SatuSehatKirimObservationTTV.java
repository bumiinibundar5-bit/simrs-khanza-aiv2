                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbSuhu.getValueAt(i,13).toString()+"T"+tbSuhu.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbRespirasi.getValueAt(i,13).toString()+"T"+tbRespirasi.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbNadi.getValueAt(i,13).toString()+"T"+tbNadi.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbSpO2.getValueAt(i,13).toString()+"T"+tbSpO2.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbGCS.getValueAt(i,13).toString()+"T"+tbGCS.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbKesadaran.getValueAt(i,13).toString()+"T"+tbKesadaran.getValueAt(i,14).toString()+"+08:00\"," +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbTensi.getValueAt(i,13).toString()+"T"+tbTensi.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"component\" : ["+
                                            "{" +
                                                "\"code\" : {" +
                                                    "\"coding\" : ["+
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbTB.getValueAt(i,13).toString()+"T"+tbTB.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbBB.getValueAt(i,13).toString()+"T"+tbBB.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
                    ...
                    try {
                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "}," +
                                        "\"effectiveDateTime\": \""+tbLP.getValueAt(i,13).toString()+"T"+tbLP.getValueAt(i,14).toString()+"+08:00\"," +
                                        "\"valueQuantity\": {" +
    ...
    private void tampilsuhu() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "reg_periksa.stts,mutasi_berkas.kembali as pulang,satu_sehat_encounter.id_encounter,"+
                   ...
                   "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join mutasi_berkas on mutasi_berkas.no_rawat=reg_periksa.no_rawat "+
                   ...
                   "and satu_sehat_observationttvsuhu.status='Ralan' where pemeriksaan_ralan.suhu_tubuh<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
            ...
            ps=koneksi.prepareStatement(
                   "select reg_periksa.tgl_registrasi,reg_periksa.jam_reg,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,"+
                   "reg_periksa.stts,concat(kamar_inap.tgl_keluar,' ',kamar_inap.jam_keluar) as pulang,satu_sehat_encounter.id_encounter,"+
                   ...
                   "ifnull(satu_sehat_observationttvsuhu.id_observation,'') as satu_sehat_observationttvsuhu from reg_periksa inner join pasien "+
                   "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join kamar_inap on kamar_inap.no_rawat=reg_periksa.no_rawat "+
                   ...
                   "and satu_sehat_observationttvsuhu.status='Ranap' where pemeriksaan_ranap.suhu_tubuh<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilrespirasi() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvrespirasi.status='Ralan' where pemeriksaan_ralan.respirasi<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvrespirasi.status='Ranap' where pemeriksaan_ranap.respirasi<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilnadi() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvnadi.status='Ralan' where pemeriksaan_ralan.nadi<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvnadi.status='Ranap' where pemeriksaan_ranap.nadi<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilspo2() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvspo2.status='Ralan' where pemeriksaan_ralan.spo2<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvspo2.status='Ranap' where pemeriksaan_ranap.spo2<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilgcs() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvgcs.status='Ralan' where pemeriksaan_ralan.gcs<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvgcs.status='Ranap' where pemeriksaan_ranap.gcs<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilkesadaran() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvkesadaran.status='Ralan' where pemeriksaan_ralan.kesadaran<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvkesadaran.status='Ranap' where pemeriksaan_ranap.kesadaran<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampiltensi() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvtensi.status='Ralan' where pemeriksaan_ralan.tensi<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvtensi.status='Ranap' where pemeriksaan_ranap.tensi<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampiltb() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvtb.status='Ralan' where pemeriksaan_ralan.tinggi<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvtb.status='Ranap' where pemeriksaan_ranap.tinggi<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampilbb() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvbb.status='Ralan' where pemeriksaan_ralan.berat<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvbb.status='Ranap' where pemeriksaan_ranap.berat<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {
    ...
    private void tampillp() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_observationttvlp.status='Ralan' where pemeriksaan_ralan.lingkar_perut<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {

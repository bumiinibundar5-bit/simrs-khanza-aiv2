                        ...
                        try{
                            ...
                            json = "{" +
                                        ...
                                        "\"dosage\": [" +
                                            ...
                                            "}" +
                                        "]," +
                                        "\"dateAsserted\": \""+tbObat.getValueAt(i,21).toString().replaceAll(" ","T")+"+08:00\"," +
                                        "\"informationSource\": {" +
                                            "\"reference\": \"Patient/"+idpasien+"\"," +
                                            "\"display\": \""+tbObat.getValueAt(i,4).toString()+"\"" +
                                        "}," +
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "satu_sehat_mapping_obat.denominator_system,resep_obat.tgl_perawatan,resep_obat.jam,resep_dokter.jml,satu_sehat_medication.id_medication,"+
                   ...
                   "where resep_obat.tgl_perawatan<>'0000-00-00' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("route_display"),rs.getString("denominator_code"),rs.getString("denominator_system"),rs.getString("tgl_perawatan")+" "+rs.getString("jam"),
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "left join satu_sehat_medicationstatement on satu_sehat_medicationstatement.no_resep=resep_dokter.no_resep and satu_sehat_medicationstatement.kode_brng=resep_dokter.kode_brng "+
                   "where resep_obat.tgl_perawatan<>'0000-00-00' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or satu_sehat_mapping_obat.kode_brng like ? or satu_sehat_mapping_obat.obat_display like ?) "));
            try {
                ps.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "satu_sehat_mapping_obat.route_code,satu_sehat_mapping_obat.route_system,satu_sehat_mapping_obat.route_display,satu_sehat_mapping_obat.denominator_code,"+
                   "satu_sehat_mapping_obat.denominator_system,resep_obat.tgl_perawatan,resep_obat.jam,resep_dokter_racikan_detail.jml,satu_sehat_medication.id_medication,"+

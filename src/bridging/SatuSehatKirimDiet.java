                ...
                try {
                    ...
                    try{
                        ...
                        json = "{" +
                                    ...
                                    "}," +
                                    "\"date\" : \""+tbObat.getValueAt(i,10).toString().replaceAll(" ","T")+"+08:00\" ," +
                                    "\"author\" : [" +
                                        "{" +
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where catatan_adime_gizi.instruksi<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "left join satu_sehat_diet on satu_sehat_diet.no_rawat=catatan_adime_gizi.no_rawat "+
                   "and satu_sehat_diet.tanggal=catatan_adime_gizi.tanggal "+
                   "where catatan_adime_gizi.instruksi<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ?) ")+

    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "reg_periksa.stts,reg_periksa.status_lanjut,date_format(mutasi_berkas.kembali,'%Y-%m-%dT%H:%i:%s+08:00') as pulang,pemeriksaan_ralan.nip,satu_sehat_encounter.id_encounter, "+
                   "prosedur_pasien.kode,icd9.deskripsi_panjang,ifnull(satu_sehat_procedure.id_procedure,'') as id_procedure "+
                   "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join mutasi_berkas on mutasi_berkas.no_rawat=reg_periksa.no_rawat "+
                   "inner join satu_sehat_encounter on satu_sehat_encounter.no_rawat=reg_periksa.no_rawat inner join prosedur_pasien on prosedur_pasien.no_rawat=reg_periksa.no_rawat inner join pegawai on pegawai.nik=reg_periksa.kd_dokter"+
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "reg_periksa.stts,reg_periksa.status_lanjut,concat(kamar_inap.tgl_keluar,'T',kamar_inap.jam_keluar,'+08:00') as pulang,satu_sehat_encounter.id_encounter, "+
                   "prosedur_pasien.kode,icd9.deskripsi_panjang,ifnull(satu_sehat_procedure.id_procedure,'') as id_procedure "+

                ...
                try {
                    ...
                    try{
                        ...
                        json = "{" +
                                    ...
                                    "},"+
                                    "\"effectiveDateTime\": \""+tbObat.getValueAt(i,14).toString()+"T"+tbObat.getValueAt(i,15).toString()+"+08:00\"," +
                                    "\"date\": \""+tbObat.getValueAt(i,14).toString()+"T"+tbObat.getValueAt(i,15).toString()+"+08:00\"," +
                                    "\"assessor\" : {"+
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "pasien.nm_pasien,pasien.no_ktp,reg_periksa.stts,mutasi_berkas.kembali "+
                   ...
                   "and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "and satu_sehat_clinicalimpression.status='Ranap' where pemeriksaan_ranap.penilaian<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ? or "+
                   "reg_periksa.stts like ?)"));
            try {

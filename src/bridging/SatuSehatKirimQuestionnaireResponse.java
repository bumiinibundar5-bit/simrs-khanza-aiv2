...
public final class SatuSehatKirimQuestionnaireResponse extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Questionnaire Response Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                    ...
                    try{
                        ...
                        headers.add("Authorization", "Bearer "+api.TokenSatuSehat());
                         json = "{" +
                            ...
                            "},"+
                            "\"authored\": \""+tbObat.getValueAt(i,11)+"T"+tbObat.getValueAt(i,12)+"+08:00\"," +
                            "\"author\" : {"+

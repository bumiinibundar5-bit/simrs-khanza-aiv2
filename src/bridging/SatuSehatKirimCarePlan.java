                ...
                try {
                    ...
                    try{
                        ...
                        json = "{" +
                                    ...
                                    "}," +
                                    "\"created\" : \""+tbObat.getValueAt(i,10).toString().replaceAll(" ","T")+"+08:00\"," +
                                    "\"author\" : {" +
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where pemeriksaan_ralan.rtl<>'' and date_format(mutasi_berkas.kembali, '%Y-%m-%d') between ? and ? "+
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "where pemeriksaan_ranap.rtl<>'' and kamar_inap.tgl_keluar between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.no_ktp like ? or pegawai.nama like ?) "));
            try {
                ps.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));

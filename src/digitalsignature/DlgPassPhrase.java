...
public class DlgPassPhrase extends javax.swing.JDialog {
    ...
    private String link="",URL="",requestJson="",viewPass="",viewnik="";
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Passphrase ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel4.setBounds(10, 220, 110, 23);
        ...
        txtNamaFile.setBounds(130, 220, 450, 30);
        ...
        jLabel7.setBounds(0, 50, 110, 23);

        BtnKeluar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/85.png"))); // NOI18N
        ...
        BtnKeluar2.setBounds(580, 10, 40, 30);

        txtNik.setForeground(new java.awt.Color(50, 50, 50));
        txtNik.setToolTipText("Silahkan masukkan passphrase");
        txtNik.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(txtNik.getText().trim().equals("")){
        ...
        }else if(txtPassPhrase.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Passphrase anda Salah");  
        }else{
            ...
            try {
                link="http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/berkastte/";
    ...
    private void txtPassPhraseKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPassPhraseKeyReleased
       
    }//GEN-LAST:event_txtPassPhraseKeyReleased
    ...
    */
    ...
    private widget.PasswordBox txtNik;
...
//            BtnDokter.setEnabled(false);
            txtNik.setText(akses.getkode());
            Sequel.cariIsi("select no_ktp from pegawai where pegawai.nik=?", txtNik.getText());
          }
